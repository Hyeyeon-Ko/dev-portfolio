...
export default function ContactForm() {
  ...
  const inputClass =
    "bg-white/50 border border-slate-200 focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all rounded-2xl px-5 py-4 outline-none placeholder:text-slate-300 font-medium w-full";
    ...
    <>
      ...
      <div className="glass-card rounded-[3rem] p-8 md:p-14 shadow-2xl shadow-slate-200/50">
        ...
        <form ref={formRef} onSubmit={onSubmit} className="space-y-8">
          ...
          <div className="flex flex-col gap-2.5">
            <label className="text-sm font-bold text-slate-600 uppercase tracking-widest ml-1">내용</label>
            <textarea
              name="message"
