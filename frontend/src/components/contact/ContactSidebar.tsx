...
export default function ContactSidebar() {
  return (
    <div className="space-y-8">
      ...
      {/* Status */}
      <div className="p-10 border border-slate-200/60 dark:border-slate-700/60 rounded-[2.5rem] bg-white/40 dark:bg-slate-800/40 backdrop-blur shadow-sm flex flex-col gap-6">
